...
<body style="background-color: grey; overflow-x: hidden;">
	<nav class="bg-dark">
		<div class="row">
			<div class="col-sm-10">
				...
				<span class="text-white">|</span>
				<button class="btn btn-dark" onclick="window.location.href='addRefund.jsp'">New Refund</button>
			</div>
	...
	<div class="container">
		<div class="card" style="margin: 2rem;">
			<h3 class="card-title text-center">New Refund</h3>
			<div class="card-body">
				<h5 class="text-danger text-center"><%=message %></h5>
				<form action="refundHandler.jsp">
					<table>
						<tr>
						...
						<tr>
							...
							<td><button class="btn btn-lg btn-dark" type="submit" required>Submit</button></td>
						</tr>
					</table>
				</form>
			</div>
