...
<body style="background-color: grey; overflow-x: hidden;">
	<nav class="bg-dark">
		<div class="row">
			<div class="col-sm-10">
				...
				<span class="text-white">|</span>
				<button class="btn btn-dark" onclick="window.location.href='addTransfer.jsp'">Transfer Funds</button>
			</div>
	...
	<div class="container">
		<div class="card" style="margin: 2rem;">
			...
			<div class="card-body">
				<form action="transferHandler.jsp">
					<table>
						<tr>
							<td><label>Date</label></td>
							<td><label>Category From</label></td>
							<td><label>Category To</label></td>
						...
						<tr>
							...
							<td>
								<select class="form-control" name="categoryFrom" id="categoryFrom">
									<%=TransController.getInstance().getCategories() %>
								</select>
							</td>
							<td>
								<select class="form-control" name="categoryTo" id="categoryTo">
									<%=TransController.getInstance().getCategories()%>
								</select>
							</td>
